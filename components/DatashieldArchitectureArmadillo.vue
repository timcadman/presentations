<template>
  <div style="position: relative; margin-top: 1rem;">
    ...
    <div class="caption-box">
      ...
      <div v-click="2"><p v-click-hide="3" class="caption-text">An Armadillo application is installed at each site</p></div>
      <div v-click="3"><p v-click-hide="4" class="caption-text">Data is uploaded to Armadillo</p></div>
    ...
    <div class="diagram-grid">
      ...
      <div v-click="2" style="grid-column: 3; text-align: left;">
        ...
        <div style="display: flex; flex-direction: column; gap: 0.5rem;">
          <div style="display: flex; align-items: center; gap: 0.5rem;"><img src="/armadillo-logo.png" style="height: 36px;" /> <span style="font-size: 13px; white-space: nowrap;">Armadillo A</span></div>
          <div style="display: flex; align-items: center; gap: 0.5rem;"><img src="/armadillo-logo.png" style="height: 36px;" /> <span style="font-size: 13px; white-space: nowrap;">Armadillo B</span></div>
          <div style="display: flex; align-items: center; gap: 0.5rem;"><img src="/armadillo-logo.png" style="height: 36px;" /> <span style="font-size: 13px; white-space: nowrap;">Armadillo C</span></div>
        </div>
      </div>
